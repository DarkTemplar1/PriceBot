...
class BazaDanychWindow(tk.Toplevel):
    ...
    def _build_ui(self):
        ...
        ttk.Button(bar, text="Zatrzymaj", command=self.on_stop).pack(side="left", padx=(6, 0))
        ttk.Button(bar, text="Scal do Polska.xlsx", command=self.run_scalanie).pack(side="left", padx=(6, 0))
    ...
    def on_stop(self):
        ...
        # nic nie działa – zwykłe zatrzymanie stanu
